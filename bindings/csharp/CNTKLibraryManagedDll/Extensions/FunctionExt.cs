...
namespace CNTK
{
    public partial class Function
    {
        ...
        public BackPropState Forward(IDictionary<Variable, Value> arguments, IDictionary<Variable, Value> outputs, DeviceDescriptor computeDevice)
        {
            if (computeDevice == null)
            {
                computeDevice = DeviceDescriptor.UseDefaultDevice();
            }
            UnorderedMapVariableValuePtr argumentVector = Helper.AsUnorderedMapVariableValuePtr(arguments);
            UnorderedMapVariableValuePtr outputVector = Helper.AsUnorderedMapVariableValuePtr(outputs);
            return Forward(argumentVector, outputVector, computeDevice);
        }
