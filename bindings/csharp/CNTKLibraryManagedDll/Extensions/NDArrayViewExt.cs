...
namespace CNTK
{
    public partial class NDArrayView
    {
        ...
        public NDArrayView(float value, NDShape viewShape, DeviceDescriptor device, bool readOnly = false) :
            this(DataType.Float, viewShape, device)
        {
            SetValue(value);

            // TODO: how to set private members of the wrapped class
